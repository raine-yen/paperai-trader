    ...
    <main className="min-h-screen bg-bg text-gray-50">
      <div className="mx-auto max-w-3xl px-5 py-16">
        ...
        <div className="mt-8 space-y-5 text-sm leading-7 text-gray-300">
          ...
          <p>All balances, trades, leaderboard rankings, learning goals, and quest points are simulated and have no real-world monetary value. The app does not include real-money trading, deposits, withdrawals, payouts, or cash-out mechanics.</p>
